...
apt-get -y install git-core openssh-server shutter google-chrome-stable vlc hipchat openjdk-8-jre openjdk-8-jdk gparted diodon caffeine nautilus-open-terminal \
